...
import pl.voytecg.ecommerce.sales.reservation.SpyPaymentGateway;
...
public class SalesTest {
    ...
    void itAllowsToAddProductToCart(){
        var customerId = thereIsExampleCustomer("Wojtek");
    ...
    void itDoesNotShareCustomersCarts(){
        var customerA = thereIsExampleCustomer("Wojtek");
